...
<?php 
	if ($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		<strong>Success!</strong> your email ' .$email.'and password'.$password.' has been submited successfult!
...
<div class="container mt-4"> 
	<h2> Add a note </h2>
	<form action="new32.php" method="post">
		<div class="form-group">
			<label for="email">Note title</label>
